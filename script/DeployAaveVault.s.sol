...
contract DeployAaveVaultScript is Script {
    ...
    AaveVaultConstructorArgs testnetArgs = AaveVaultConstructorArgs({
        ...
        asset: IERC20(0x75faf114eafb1BDbe2F0316DF893fd58CE46AA4d),
        atoken: IERC20(0x460b97BD498E1157530AEb3086301d5225b91216),
    ...
    AaveVaultConstructorArgs baseArgs = AaveVaultConstructorArgs({
        ...
        asset: IERC20(0x833589fCD6eDb6E08f4c7C32D4f71b54bdA02913),
        atoken: IERC20(0x4e65fE4DbA92790696d040ac24Aa414708F5c0AB),
    ...
    AaveVaultConstructorArgs polygonArgs = AaveVaultConstructorArgs({
        ...
        asset: IERC20(0x3c499c542cEF5E3811e1192ce70d8cC03d5c3359),
        atoken: IERC20(0xA4D94019934D8333Ef880ABFFbF2FDd611C762BD),
        gateway: IGatewayEVM(0x48B9AACC350b20147001f88821d31731Ba4C30ed),
        yieldMil: address(0) // proxy
    });
    ...
    function run() public {
        ...
        new AaveVault(args.pool, args.asset, args.atoken, args.gateway, args.yieldMil);
        vm.stopBroadcast();
    }
